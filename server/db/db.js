...
async function init() {
  ...
  const migrations = [
    ...
    `ALTER TABLE wall_messages ADD COLUMN auto_generated INTEGER NOT NULL DEFAULT 0`,         // EPIC-2338-IMPL: epitafios auto-generados vs mensajes de jugadores
    ];
 ...
 */
function addWallMessage(roomId, playerName, message, autoGenerated = false) {
  run('INSERT INTO wall_messages (room_id, player_name, message, auto_generated) VALUES (?, ?, ?, ?)', [roomId, playerName, message, autoGenerated ? 1 : 0]);
