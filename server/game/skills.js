...
const SKILLS = {
  smash: {
    ...
    type: 'attack',
    dmg_multiplier: 1.8,
    description: 'Un golpe devastador que hace ×1.8 del daño normal. Cooldown: 30s de reloj real (no turnos de combate). No disponible contra enemigos con muy poco HP. Solo Guerrero (o sin clase aún).',
    combat_only: true,
