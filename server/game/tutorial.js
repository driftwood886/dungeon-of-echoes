...
const COMPLETE_MSG = `🎉 ¡TUTORIAL COMPLETADO!\nGanás +10 XP y +40 de oro de bonus por completar el entrenamiento.\n🌿 El guardia te da 2 hierbas curativas como provisiones de inicio. (Usá «use hierba curativa» para curar HP)\nAhora estás en la Entrada de la Cripta. ¡Buena suerte, aventurero/a!\n\n⚔️  PRÓXIMO PASO: Elegí tu vocación con el comando:\n  clase\n  (Guerrero, Pícaro o Mago — cada uno cambia tu forma de combatir)\n\n🔧 TIP DE CRAFTEO: En el dungeon vas a encontrar materiales combinables.\n   Ejemplo: escudo roto + garra de esqueleto → escudo de gladiador (+DEF)\n   Usá:  craftear escudo de gladiador  (o  craft escudo roto con garra de esqueleto)\n   El comando «recetas» muestra todas las combinaciones disponibles.\n\n📜 TIP DE MISIONES: El dungeon tiene misiones activas — escribí «quests» para ver las tuyas.\n   Completarlas da XP extra, oro y reputación.\n\n🏴 TIP DE FACCIONES: Al llegar al nivel 3, tres facciones rivales te invitarán a unirte.\n   Escribí «facciones» cuando llegues a nivel 3 para ver tus opciones.\n   Cada facción tiene misiones semanales y beneficios exclusivos.\n\n📖 TIP DE LORE: El dungeon esconde secretos. Cuando encontrés objetos con texto, usá «read» para leerlos.\n   Los fragmentos se guardan en tu diario — escribí «lore» para releerlos cuando quieras.\n\n💡 TIP: Hay una Sala de Práctica al fondo (escribí «abajo» desde aquí).\n   Sin riesgo, sin penalidades. Ideal para aprender los comandos antes de entrar al dungeon real.\n\nEscribí «look» para ver dónde estás, «help» para ver todos los comandos.`;

// DIS-D278: Variante para jugadores que YA eligieron clase (al registrarse o durante el tutorial)
const COMPLETE_MSG_WITH_CLASS = `🎉 ¡TUTORIAL COMPLETADO!\nGanás +10 XP y +40 de oro de bonus por completar el entrenamiento.\n🌿 El guardia te da 2 hierbas curativas como provisiones de inicio. (Usá «use hierba curativa» para curar HP)\nAhora estás en la Entrada de la Cripta. ¡Buena suerte, aventurero/a!\n\n🔧 TIP DE CRAFTEO: En el dungeon vas a encontrar materiales combinables.\n   Ejemplo: escudo roto + garra de esqueleto → escudo de gladiador (+DEF)\n   Usá:  craftear escudo de gladiador  (o  craft escudo roto con garra de esqueleto)\n   El comando «recetas» muestra todas las combinaciones disponibles.\n\n📜 TIP DE MISIONES: El dungeon tiene misiones activas — escribí «quests» para ver las tuyas.\n   Completarlas da XP extra, oro y reputación.\n\n🏴 TIP DE FACCIONES: Al llegar al nivel 3, tres facciones rivales te invitarán a unirte.\n   Escribí «facciones» cuando llegues a nivel 3 para ver tus opciones.\n   Cada facción tiene misiones semanales y beneficios exclusivos.\n\n📖 TIP DE LORE: El dungeon esconde secretos. Cuando encontrés objetos con texto, usá «read» para leerlos.\n   Los fragmentos se guardan en tu diario — escribí «lore» para releerlos cuando quieras.\n\n💡 TIP: Hay una Sala de Práctica al fondo (escribí «abajo» desde aquí).\n   Sin riesgo, sin penalidades. Ideal para practicar antes de aventurarte al dungeon real.\n\nEscribí «look» para ver dónde estás, «help» para ver todos los comandos.`;
