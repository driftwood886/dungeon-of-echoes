...
const ITEM_CATALOG = {
  ...
  'cuchillo oxidado':    { type: 'weapon', effect: 'attack_bonus', amount: 1,  description: 'Un cuchillo pequeño y oxidado. +1 de ataque. Ingrediente para craftear cuchillo envenenado (craft veneno concentrado con cuchillo oxidado).' },
  ...
  'lanza espectral':     { type: 'weapon', effect: 'attack_bonus', amount: 10, spectral_bonus: 2, description: 'Una lanza hecha de luz negra condensada, fría al tacto como el mármol pero sin peso. Artesanía del Elemental de Hielo condensada en forma de arma. +10 de ataque; +2 ATK adicional contra espectrales y criaturas mágicas. ⚠️ Ingrediente de crafteo: lanza espectral + esencia etérea → lanza espectral reforzada (+11 ATK). No la vendas si querés la versión mejorada.' },
  ...
  'alabarda de huesos':  { type: 'weapon', effect: 'attack_bonus', amount: 10, not_for_mage: true, not_for_clerigo: true, description: 'La alabarda de un guardia espectral, forjada mientras el portador aún estaba vivo. Ligera a pesar de estar hecha de hueso comprimido. Los bordes están marcados con el símbolo del Reino de Valdrath —el mismo de los escudos de la Sala del Trono. Un arma de boss que supera ampliamente lo que se consigue en tienda. +10 de ataque. Solo puede ser empuñada por Guerreros y Pícaros (DIS-1737). 🔧 Pista: combinala con esencia etérea para obtener la Alabarda Espectral (+12 ATK con efecto especial).' },
  ...
  'hongo azul':          { type: 'misc', description: 'Un hongo luminiscente de color azul profundo. Tiene propiedades alquímicas. ⚠️ También desactiva la trampa de esporas del Túnel de los Hongos (sala 6) — si planificás cruzarlo sin daño, no lo craftees. 🔧 Pista: combinalo con veneno concentrado → brebaje del hongo, o con diente afilado → veneno de colmillo (40% de envenenar). 🙏 Ofrenda al altar: Resonancia Fúngica (+1 ATK, +8 maná, 90s).' },
  ...
  'escudo de gladiador': { type: 'armor', effect: 'defense_bonus', amount: 2, description: 'El escudo de un gladiador del coliseo de huesos. Lleva el nombre "MAXIMUS" grabado. Otorga +2 DEF. ⚠️ Ocupa el slot de armadura — no se puede usar junto a otra armadura de cuerpo.' },
  'emblema del coliseo': { type: 'misc', description: 'Un medallón de bronce ennegrecido con la silueta de dos gladiadores en relieve. En el reverso: «VARETH — campeón invicto». Frío al tacto, como algo que no debería seguir existiendo. 📖 Usá «examine emblema del coliseo» para leer la historia del Campeón Espectral.' },
  ...
  'carta sellada':       { type: 'misc', description: 'Un sobre sellado con cera negra marcado con dos llaves cruzadas — el sello del reino de Valdrath. En el reverso, en letra pequeña: "Para quien llegue después. Perdoname." Sin firma. 🔍 El mercader Aldric (sala 4) reconoce ese sello — si ya sos nivel 5, usá `hablar aldric` en su tienda. Podés abrirla directamente con `use carta sellada`.' },
  'carta leída':         { type: 'misc', description: 'La carta que encontraste en la Prisión Subterránea, ahora abierta. El papel está doblado en cuatro, con el sello de cera negra partido. Lo que decía está grabado en tu memoria. 📖 Usá `examine carta leída` para releer su contenido. No tiene valor de venta — es un recuerdo.' },
  'páginas congeladas':  { type: 'misc', description: 'Fragmentos de un diario conservados por el hielo. La escritura es difusa pero legible: "Sé quién es. Eso lo hace peor." La última entrada es del mismo año en que el Reino de Valdrath dejó de aparecer en los mapas. 📖 Usá `examine páginas congeladas` (o `use`) para leer los fragmentos completos — revelan algo sobre quien ata este dungeon y dónde encontrarlo.' },
  ...
  'diagrama quemado':    { type: 'misc', description: 'Un pergamino parcialmente calcinado. Las líneas que sobrevivieron muestran esquemas técnicos —planos de algo que nunca se terminó. En el margen, en letra apurada: \"Si alguien llega hasta aquí, Aldric sabe el resto. Que lo recuerde.\" 📖 Usá `examine diagrama quemado` para estudiarlo mejor.' },
