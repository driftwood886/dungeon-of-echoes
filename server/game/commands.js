...
const COMMAND_HELP = {
  ...
  stance:    'stance [postura] / postura [postura]\\\\n  Ver o cambiar tu postura de combate.\\\\n  Posturas: agresivo (+2ATK/-1DEF/5% miss extra; Pícaro: también +2% crítico), defensivo (-1ATK/+2DEF), equilibrado.\\\\n  La postura persiste entre sesiones.\\\\n  ⚠️ DIFERENTE a \"defender\" (postura_defensiva del Guerrero, táctica de 1 turno en combate).',
  path:      'path <destino> / ruta <destino>\\\\\\\\n  Calcular la ruta más corta hasta una sala.\\\\\\\\n  Destino puede ser un ID numérico (ej: path 15), parte del nombre (ej: path catedral),\\\\\\\\n  o un alias: mercader/tienda/aldric → sala 4, subastas → sala 17, entrada/salida → sala 1,\\\\\\\\n  catedral/lich → sala 15, santuario → sala 10, forja/coliseo/abismo/eco → sus salas,\\\\\\\\n  jefe/boss → boss más cercano accesible.\\\\\\\\n  Muestra los pasos como comandos move con nombre de sala de destino.\\\\\\\\n  Advierte sobre enemigos activos en salas de paso, trampas y bosses en el camino.\\\\\\\\n  Sin cooldown. Útil para navegar el dungeon eficientemente.',
  ...
  // DIS-2319: ayuda detallada para habilidades del Pícaro
  golpe_sucio: 'golpe_sucio [monstruo]\\\\n  Habilidad de Pícaro desbloqueada en Nivel 3.\\\\n  Ataque traicionero: ×1.3 daño + veneno (3 dmg × 3 turnos al monstruo).\\\\n  Cooldown: 50 segundos.\\\\n  Si hay múltiples monstruos, especificá el nombre: golpe_sucio zombie',
  sigilo:    'sigilo / hide\\\\n  Habilidad de Pícaro disponible desde Nivel 1.\\\\n  Entrás en sigilo: el próximo ataque (attack) tiene garantía de golpe de sorpresa (+50% daño).\\\\n  El sigilo se cancela al moverte a una sala sin monstruos.\\\\n  Escribí «status» para ver si tenés el sigilo activo.',
  sombras:   'sombras\\\\n  Habilidad del Pícaro: activa el Golpe desde las Sombras cuando tenés 3 puntos de sombra acumulados.\\\\n  Los puntos de sombra se acumulan atacando (1 por turno de combate).\\\\n  Se disipan al moverte a salas sin monstruos — planificá la ruta.\\\\n  Al llegar a 3 puntos verás: ⚡ ¡Listo! Escribí «sombras» para activar.\\\\n  Daño: ×2.5 con 25% de crítico adicional.',
  evasion:   'evasion / evasión\\\\n  Habilidad de Pícaro desbloqueada en Nivel 6.\\\\n  Postura de esquiva garantizada: el próximo ataque del monstruo falla completamente.\\\\n  Dura 1 turno de combate. Cooldown: 60 segundos.',
  robar:     'robar / steal\\\\n  Habilidad del Pícaro disponible desde Nivel 1.\\\\n  Intenta robar monedas de un monstruo humanoide de la sala.\\\\n  Solo funciona en humanoides (esqueletos, zombies, guardias). Las bestias no llevan cartera.\\\\n  Cooldown: 30 segundos.',
  ...
  resurreccion: 'resurreccion / resurrección / resurrect / revivir\\\\\\\\\\\\\\\\n  Habilidad de Clérigo desbloqueada en Nivel 10.\\\\\\\\\\\\\\\\n  Resurrección divina: al morir, volvés a la Entrada con 50% HP.\\\\\\\\\\\\\\\\n  Costo: 40 maná. Cooldown: 5 minutos.\\\\\\\\\\\\\\\\n  Solo funciona si tenés suficiente maná al momento de morir.\\\\\\\\\\\\\\\\n  Usá el nombre directamente como comando: resurreccion',
  cast:      'cast <hechizo> [objetivo] / lanzar <hechizo>\\n  Lanzar un hechizo gastando maná.\\n  Hechizos disponibles:\\n    rayo menor / chispa  — 7 daño, costo 6 maná (recurso de bajo coste para Mago)\\n    bola de fuego / fuego — 10 daño (12 Mago lv1-2, 15 Mago lv3+), costo 8 maná\\n    escudo / shield      — +5 DEF por 1 turno en combate, costo 6 maná\\n    curación / heal      — +15 HP, costo 10 maná\\n    rayo / lightning     — 15 daño (18 Mago lv1-2, 22 Mago lv3+), 25% stun, costo 12 maná\\n  El maná se recarga 1/min (6/min para Magos). Usá pociones de maná para recargar rápido.\\n  Ej: \\"cast fuego goblin\\", \\"cast curación\\", \\"cast rayo guardia espectral\\"',
  vault:     'vault / bóveda / cofre\\\\\\\\n  Bóveda personal — disponible en la Entrada (sala 1), la Cámara del Tesoro de Aldric (sala 4), la Casa de Subastas (sala 17) o la Cámara del Eco (sala 19).\\\\\\\\n  vault store <ítem>  — Guardar un ítem del inventario en la bóveda (máx 10 ítems)\\\\\\\\n  vault take <ítem>   — Sacar un ítem de la bóveda al inventario\\\\\\\\n  vault (sin args)    — Listar el contenido de tu bóveda\\\\\\\\n  Los ítems en la bóveda son seguros: no se pierden al morir en Hardcore.',
  enchant:   'enchant <tipo_runa> / encantar <tipo_runa>\\\\\\\\n  Encantar el arma equipada consumiendo 1 runa del tipo indicado.\\\\\\\\n  Efectos por tipo (duración 3 minutos):\\\\\\\\n    fuego  — +2 ATK\\\\\\\\n    hielo  — 20% chance de ralentizar al monstruo (skip su turno)\\\\\\\\n    sombra — +15% probabilidad de crítico adicional\\\\\\\\n    luz    — +3 HP al matar cada monstruo\\\\\\\\n    caos   — efecto aleatorio entre los anteriores\\\\\\\\n  Conseguís runas al matar monstruos (40% de chance, 100% en bosses). Ver colección con \"runas\".',
  runas:     'runas / runes\\\\n  Ver tu colección de runas y guía completa del sistema.\\\\n  Tipos de runas (5 en total): fuego 🔥, hielo ❄️, sombra 🌑, luz ✨, caos 🌀\\\\n  Cómo obtenerlas:\\\\n    • Cualquier monstruo puede soltar 1 runa al morir (40% de chance, 100% en bosses).\\\\n    • El tipo de runa es aleatorio — no hay monstruo específico.\\\\n  Fusión:\\\\n    • Al juntar 3 del mismo tipo se fusionan automáticamente.\\\\n    • La fusión otorga +1 ATK permanente al arma equipada.\\\\n  Encantamiento:\\\\n    • Usá "enchant <tipo>" para consumir 1 runa y encantar tu arma.\\\\n    • El encantamiento dura 3 minutos con el efecto del tipo elegido.',
  // DIS-2085: ayuda del sistema de combos
  combo:     'combo / combos\\\\n  Sistema de combos: atacar al MISMO monstruo varias veces seguidas acumula un combo.\\\\n  El combo incrementa hasta x5 máximo.\\\\n  Bonus de daño: min(comboCount-1, ceil(nivel/4))\\\\n    → Nivel 1-4: máx +1 daño al llegar a x2\\\\n    → Nivel 5-8: máx +2 daño al llegar a x3\\\\n    → Nivel 9-12: máx +3 daño al llegar a x4\\\\n    → Nivel 13+: máx +4 daño al llegar a x5\\\\n\\\\n  ⚡ ¡COMBO x2!  →  primer combo, +1 daño (si nivel ≥ 1)\\\\n  🔥 ¡COMBO x3!  →  +bonus según nivel\\\\n  💥 ¡COMBO x4!  →  acumulando potencia\\\\n  🌟 ¡COMBO x5!  →  combo máximo, golpe devastador\\\\n\\\\n  ⚠️  El combo se RESETEA si:\\\\n    • Cambiás de objetivo (atacás a otro monstruo)\\\\n    • Te movés a otra sala\\\\n    • El monstruo muere\\\\n\\\\n  Ver combo activo: status (aparece si hay x2 o mayor)',
  // DIS-1343: ayuda contextual para especializar
  especializar: 'especializar / especializarse / subclase\\\\n  Elegir tu especialización permanente de clase (disponible desde Nivel 5).\\\\n  Esta decisión es PERMANENTE — no se puede cambiar después.\\\\n\\\\n  Especializaciones por clase:\\\\n    Guerrero:  Paladín 🛡️  — tanque sagrado, escudo divino, curación en combate\\\\n               Berserker 🪓 — daño devastador, +3 ATK, -1 DEF, modo berserk\\\\n    Mago:      Evoker 🔮   — hechizos potenciados, mayor daño mágico\\\\n    Pícaro:    Asesino 🗡️  — daño crítico elevado, emboscadas letales\\\\n               Ladrón de Sombras 🎭 — robo garantizado, sigilo mejorado, ventas ventajosas\\\\n    Clérigo:   Sanador ✨  — curación masiva, buffs grupales, resurrección mejorada\\\\n               Juicio ⚖️   — daño sagrado, condenar al objetivo, rayo divino\\\\n\\\\n  Uso:\\\\n    especializar           — Ver las opciones de tu clase y sus bonificaciones\\\\n    especializar <nombre>  — Confirmar la elección (ej: especializar berserker)\\\\n\\\\n  ⚠️  Necesitás estar en Nivel 5 o superior. Solo una vez por personaje.',
  // DIS-2205: help del sistema de duelos PvP
  duel: 'duel <jugador> / duelo <jugador>\\\\n  Retar a un duelo PvP a otro aventurero en la misma sala.\\\\n\\\\n  El duelo es un combate 1v1 consensuado entre jugadores:\\\\n    • Ambos deben estar en la misma sala.\\\\n    • El retado tiene 30 segundos para aceptar (accept) o rechazar (decline).\\\\n    • El duelo simula combate normal (ATK, DEF, HP) pero sin muerte real.\\\\n    • El perdedor queda con 1 HP — no hay muerte ni penalización de XP.\\\\n\\\\n  Comandos relacionados:\\\\n    duel <nombre>  — Retar a duelo (ej: duel Kira)\\\\n    accept         — Aceptar el reto de duelo pendiente\\\\n    decline        — Rechazar el reto de duelo pendiente\\\\n\\\\n  🏆 Misión de facción: si pertenecés a La Orden del Filo, ganar un duelo puede\\\\n  avanzar la misión semanal de ranking \\\"Duelo por la Orden\\\".\\\\n  Ver misiones de la facción: facciones — Ver tu misión de orden: mision-faccion',
  // DIS-2258: ayuda detallada del Sistema de Ascensión
  ascender: 'ascender / ascend / ascension\\\\n  Sistema de Ascensión roguelite — disponible al derrotar al Lich Anciano (sala 15).\\\\n\\\\n  ¿Qué es ascender?\\\\n  Al ascender dejás ir a tu personaje actual, pero heredás un bonus permanente\\\\n  que arranca desde el comienzo del próximo ciclo. Tu nombre queda grabado en el Salón de los Caídos.\\\\n\\\\n  Flujo de ascensión:\\\\n    1. Derrotá al Lich Anciano (nivel 15+, sala 15 — La Cámara del Lich)\\\\n    2. Escribí `ascender` para ver las 3 opciones de legado\\\\n    3. Elegí una: `ascender 1`, `ascender 2` o `ascender 3`\\\\n    4. Podés agregar un epitafio: `ascender 1 Que el eco de mis pasos perdure`\\\\n    5. Confirmá con `ascender 1 confirmar` — se crea tu nuevo personaje con el bonus\\\\n\\\\n  Qué conservás / qué perdés:\\\\n    • Conservás: el bonus de legado + tu nombre en el Salón de los Caídos\\\\n    • Perdés: nivel, ítems, gold, quests y progreso del personaje actual\\\\n    • Obtenés: ventaja permanente de inicio (varía según el legado elegido)\\\\n\\\\n  Legados posibles (3 aleatorios de un pool mayor):\\\\n    🌟 Ejemplos: +HP máximo, +ATK permanente, +maná inicial, bonus de XP, etc.\\\\n    El legado correcto depende de la clase que elijas en el próximo ciclo.\\\\n    Algunos legados tienen efectos por clase (ej: +5 ATK para Guerrero, +10 MP para Mago).\\\\n\\\\n  Especializaciones disponibles (se eligen desde nivel 5 con `especializar`):\\\\n    Guerrero:  Paladín 🛡️  — tanque sagrado | Berserker 🪓 — daño puro\\\\n    Mago:      Evoker 🔮   — hechizos potenciados\\\\n    Pícaro:    Asesino 🗡️  — críticos elevados | Ladrón de Sombras 🎭 — robo y sigilo\\\\n    Clérigo:   Sanador ✨  — curación masiva  | Juicio ⚖️ — daño sagrado\\\\n\\\\n  Comandos útiles:\\\\n    ascender           — Ver opciones de legado (solo si ya derrotaste al Lich)\\\\n    ascender cancelar  — Volver al juego sin ascender (tu personaje sigue activo)\\\\n    salon              — Ver el Salón de los Caídos (legados de otros aventureros)\\\\n    especializar       — Elegir subclase desde nivel 5',
  };
